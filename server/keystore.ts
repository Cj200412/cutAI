...
export const KEY_NAMES = [
  ...
  'VOICE_CUSTOM_API_KEY', 'VOICE_CUSTOM_BASE_URL',
  ...
  'VOICE_CUSTOM_MODEL', 'VOICE_CUSTOM_VOICE',
...
export function computeCaps(): Caps {
  ...
  return {
    image: has('IMAGE_API_KEY') || has('OPENAI_API_KEY') || has('IMAGE_BASE_URL') || has('GEMINI_API_KEY') || has('MINIMAX_API_KEY'),
    voice: (has('DOUBAO_TTS_APP_ID') && has('DOUBAO_TTS_ACCESS_KEY')) || has('ELEVENLABS_API_KEY')
      || has('MINIMAX_API_KEY') || has('VOICE_CUSTOM_BASE_URL'),
    ...
    stock: has('PEXELS_API_KEY') || has('PIXABAY_API_KEY') || has('UNSPLASH_ACCESS_KEY')
      || has('FREESOUND_API_KEY') || has('FIRECRAWL_API_KEY') || has('FIRECRAWL_BASE_URL'),
    ...
    web: has('FIRECRAWL_API_KEY') || has('FIRECRAWL_BASE_URL'),
